  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    ...
    <div class="flex flex-col items-center gap-2 mb-6">
        <button
          ...
          class="bg-primary hover:opacity-90 text-white px-6 py-2 rounded-lg">Učitaj sliku</button>
      ...
      <div class="flex justify-between">
        ...
        <button
          ...
          class="bg-primary text-white px-6 py-2 rounded-lg hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed">Sacuvaj</button>
      </div>
    </div>
  </div>
</template>
