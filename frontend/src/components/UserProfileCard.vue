<template>
  <div class="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl shadow p-6 mb-6 transition-colors">
       ...
       <div class="flex-1">
        <div class="flex justify-between items-start">
          <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm mt-1">{{ profile.role }}</p>
          </div>
    ...
    Uredi profil
         ...
         <div class="grid grid-cols-2 gap-3 mt-4 text-sm text-gray-600 dark:text-gray-300">
          <div class="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-primary dark:text-orange-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
