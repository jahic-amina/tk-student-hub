...
<template>
  <div>
    ...
    <div class="relative">
      ...
      >
        <p class="text-[10px] text-slate-400 font-semibold uppercase tracking-wider px-2 mb-1.5">Popularni tagovi</p>
        <div class="flex flex-wrap gap-1.5 px-1">
          <button
            ...
            class="text-xs px-2.5 py-1 rounded-full bg-orange-50 text-orange-600 border border-orange-200 hover:bg-orange-100 transition-colors font-medium"
          >
            #{{ tag.name }}
            <span class="text-orange-400 ml-0.5 text-[9px]">({{ tag.usage_count }})</span>
          </button>
        </div>
      </div>
    </div>
