...
| Tim 3 | Forum | `backend/app/models`,`backend/app/routers`, `backend/app/services`.`frontend/src/components`,`frontend/src/composables`,`frontend/src/services`,`frontend/src/views/forum`,`frontend/src/views/forum/admin` (Sve sto sadrzi `forum` u nazivu) | Amar Ascic, Ehlimana Beganovic, Iman Osmic, Edin Hodzic |
